...
import { Insurance, reset, setInsuranceDisability } from "../../core/insuranceCore";
...
export default function DisabilityInsurance() {
    ...
    function setInsuranceForm(
        ...
        dispatch(
            setInsuranceDisability(insurance)
        )
    }
                ...
                children: <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div>
                        <FormInput
                            ...
                            value={insurance.disability[FormType.work]}
                        />
                    </div>
                    <div>
                        <FormInput
                            ...
                            value={insurance.disability[FormType.job]}
                        />
                    </div>
                    <div>
                        <FormInput
                            id={FormType.disabilityMonthlyPension}
                            type={InputType.radio}
                            required={required}
                            title={FormType.disabilityMonthlyPension}
                            listValues={[
                                "€ 500,- bis € 1.000,- monatlich",
                                "€ 1.000,- bis € 2.000,- monatlich",
                                "€ 2.000,- und mehr"
                            ]}
                            value={insurance.disability[FormType.disabilityMonthlyPension]}
                        />
                    </div>
                    <div>
                        <FormInput
                            id={FormType.disabilityEndAge}
                            type={InputType.list}
                            required={required}
                            title={FormType.disabilityEndAge}
                            listValues={[
                                "60",
                                "63",
                                "65",
                            ...
                            value={insurance.disability[FormType.disabilityEndAge]}
                        />
                    </div>
                </div>
            },
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        <div>
                            <FormInput
                                ...
                                value={insurance.disability[FormType.salutation]}
                            />
                        </div>
                        <div>
                            <FormInput
                                ...
                                placeholder="zB.: Ing."
                                value={insurance.disability[FormType.academicTitlePre]}
                            />
                        </div>
                        <div>
                            <FormInput
                                ...
                                value={insurance.disability[FormType.firstname]}
                            />
                        </div>
                        <div>
                            <FormInput
                                ...
                                value={insurance.disability[FormType.lastname]}
                            />
                        </div>
                        <div>
                            <FormInput
                                ...
                                placeholder="zB.: BSc"
                                value={insurance.disability[FormType.academicTitlePost]}
                            />
                        </div>
                        <div>
                            <FormInput
                                ...
                                value={insurance.disability[FormType.citizenship]}
                            />
                        </div>
                        <div>
                            <FormInput
                                ...
                                value={insurance.disability[FormType.birthday]}
                            />
                        </div>
                        <div>
                            <FormInput
                                ...
                                value={insurance.disability[FormType.address]}
                            />
                        </div>
                        <div>
                            <FormInput
                                ...
                                placeholder="zB.: 28/2"
                                value={insurance.disability[FormType.doornumber]}
                            />
                        </div>
                        <div>
                            <FormInput
                                ...
                                placeholder="zB.: 2500"
                                value={insurance.disability[FormType.postalCode]}
                            />
                        </div>
                        <div>
                            <FormInput
                                ...
                                value={insurance.disability[FormType.city]}
                            />
                        </div>
                        <div>
                            <FormInput
                                ...
                                value={insurance.disability[FormType.email]}
                            />
                        </div>
                        <div>
                            <FormInput
                                ...
                                value={insurance.disability[FormType.phoneNumber]}
                            />
                        </div>
                    </div>
                    <div className="flex">
                        <FormInput
                            ...
                            value={insurance.disability[FormType.orderAccepted]}
                            onChange={() => {
                                const newInsurance: Insurance = { vehicle: {}, ownHome: {}, law: {}, accident: {}, health: {}, disability: {}, life: {} }
                                newInsurance.disability[FormType.orderAccepted] = state().insuranceCore.disability[FormType.orderAccepted] == 'NEIN' ? 'JA' : 'NEIN'
    ...
    async function sendEmail(): Promise<Response> {
        return await fetch('/api/general', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json', 'order': 'Berufsunfähigkeits-Versicherung' },
            body: JSON.stringify(state().insuranceCore.disability)
        })
    }
    ...
    return <Progress
        ...
        onNextStep={(formData) => {
            ...
            insuranceFormTypes.forEach((type) => {
                newInsurance.disability[type] = formData.get(type)?.toString() ?? ""
            })

            newInsurance.disability[FormType.orderAccepted] = newInsurance.disability[FormType.orderAccepted] != 'NEIN' ? 'JA' : 'NEIN'
